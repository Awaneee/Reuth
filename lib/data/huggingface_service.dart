...
''';
  ...
  static Future<String> generateChatbotResponse(
      String userMessage, String sentiment, double confidence) async {
    try {
...
''';
  ...
  static String _getFallbackResponse(
      String userMessage, String sentiment, double confidence) {
    ...
    if (text.contains('chest pain') ||
        text.contains('severe chest') ||
        (text.contains('chest') && text.contains('pain'))) {
