          ...
          Wrap(
            ...
            children: [
              Chip(
                ...
                label: const Text("Heart: 72 bpm",
                    style: TextStyle(color: Colors.black87)),
              ),
              Chip(
                backgroundColor: const Color(0xFFF8F8F8),
                label: const Text("BP: 120/80",
                    style: TextStyle(color: Colors.black87)),
              ),
              Chip(
                backgroundColor: const Color(0xFFF8F8F8),
                label: const Text("Meds: 3",
                    style: TextStyle(color: Colors.black87)),
              ),
              Chip(
                backgroundColor: const Color(0xFFF8F8F8),
                label: const Text("Weight: 75 kg",
                    style: TextStyle(color: Colors.black87)),
              ),
            ],
          ),
...
class _ChatbotScreenState extends State<ChatbotScreen> {
  final List<_Message> _messages = [
    _Message(
        text: "Experiencing discomfort in my knee.",
        isUser: true,
        time: "10:45 AM"),
    _Message(
        text: "Apply cold compress, book follow-up if needed.",
        isUser: false,
        time: "10:47 AM"),
  ];
      ...
      child: ListView(
        ...
        children: [
          _buildPrescriptionCard(
              "Amlodipine Besylate", "10mg daily • Refill Due"),
          _buildPrescriptionCard(
              "Metformin Hydrochloride", "500mg twice daily • Viewed"),
